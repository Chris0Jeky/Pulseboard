...
-- another dimension, and it deliberately has no timestamp finer than the UTC day, so it cannot be
-- re-joined to the statistics row written by the same request. Re-running this file is a no-op.
