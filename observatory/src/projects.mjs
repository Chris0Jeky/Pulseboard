...
export const projects = {
  ...
  alibi: { ...p('Alibi', 'https://alibi-after-hours-preview.commit-atlas.workers.dev', '/', 'Alibi', ['puzzle.started', 'puzzle.completed', 'hint.requested'], ['home', 'puzzle', 'castle', 'quiet-wing', 'other'], 'ALIBI'),
