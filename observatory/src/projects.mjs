...
const alibi = {
  ...p(
    ...
    '/',
    'Alibi',
    ['puzzle.started', 'puzzle.completed', 'hint.requested'],
    ['home', 'puzzle', 'castle', 'quiet-wing', 'other'],
    'ALIBI',
  ),
  // Keep the old label while deployed clients age out. New clients report their exact app version.
...
export const projects = {
  mdviewer: p(
    ...
    '/',
    'MDviewer',
    ['export.print_requested', 'export.pdf_completed'],
    ['home', 'editor'],
  ),
  commitatlas: p(
    'CommitAtlas',
    ...
    '/',
    'CommitAtlas',
    ['studio.opened', 'card.exported'],
    ['home', 'studio', 'other'],
    'COMMITATLAS',
  ),
  alibi,
  'developer-lens': p(
    'Developer Lens showcase',
    'https://chris0jeky.github.io',
    '/developer-lens/',
    'Developer',
    ['story.opened', 'share.requested'],
    ['home', 'story', 'share'],
  ),
  idleharbor: p(
    'IdleHarbor site',
  ...
  portfolio: p(
    'Portfolio',
    'https://chris0jeky.github.io',
    '/CV_and_Portfolio/Portfolio/portfolio.html',
    'Tcaci',
    ['project.opened', 'contact.requested'],
    ['home', 'project', 'cv'],
  ),
  wealthlens: p(
    'WealthLens site',
  ...
  taskdeck: {
    label: 'Taskdeck (local-first)',
    origin: null,
    probe: null,
    events: common,
    routes: ['home', 'board', 'settings'],
    releases: ['unattributed'],
    measurements: ['duration.ms'],
    dailyLimit: 1000,
  },
