...
export const projects = {
  ...
  alibi: { ...p('Alibi', 'https://alibi-after-hours-preview.commit-atlas.workers.dev', '/', 'Alibi',
      ['puzzle.started', 'puzzle.retried', 'puzzle.completed', 'puzzle.failed', 'hint.requested'],
      ['home', 'puzzle', 'castle', 'quiet-wing', 'other'], 'ALIBI'),
    releases: ['unattributed', '0.11.3', '0.11.4'], contextGlobal: 'ALIBI_OBSERVATORY_CONTEXT',
    journey: { schema: 'pulseboard.named-journey/1', id: 'puzzle', label: 'Puzzle attempt',
      events: { initial: 'puzzle.started', retry: 'puzzle.retried', completed: 'puzzle.completed', failed: 'puzzle.failed', hint: 'hint.requested' } } },
